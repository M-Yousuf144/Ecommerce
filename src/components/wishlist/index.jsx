    ...
    render (){
                 ...
                 {(item.product.formated_special_price != '')?<del style={{fontSize:'15px'}}><span class="money">{item.product.formated_regular_price}</span></del> :''}</h2>
                                                        ...
                                                        <div class="col-xs-3">
                                                            <h2 class="td-color">
                                                                ...
                                                                <FiShoppingCart className='mx-3 text-dark'  onClick={() => movetocartitem(item.id)} />
     ...
     {(item.product.formated_special_price != '')?<del style={{fontSize:'15px'}}><span class="money">{item.product.formated_regular_price}</span></del> :''}
                                                ...
                                                <MdDeleteOutline className='mx-4' style={{fontSize:28,marginRight:"50px",cursor:'pointer'}} onClick={() => handleClick(item.product.id)}/>
                                                    ...
                                                    <FiShoppingCart className='mx-4' style={{fontSize:25,cursor:'pointer'}} onClick={() => movetocartitem(item.id)} />
                                                </td>
                                            </tr>
                                            </tbody> )
                                    })}
                        ...
                        <div class="row wishlist-buttons">
                            <div class="col-12">
                            <Link to={`${process.env.PUBLIC_URL}/shopPage`}><button type="button" class="btn-solid btn">Continue Shopping</button></Link>  
