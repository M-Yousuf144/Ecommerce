...
<div class="container-fluid mt-12 mb-12"  style={{paddingTop:"10px"}}>
                ...
                <div class="row g-0">
                    ...
                    <table class="table  table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><input className="" type="checkbox" name="return" /></td>
                            <td>
                    ...
                    <div class="col-md-6 background-muted">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-6">
                                <div class="p-3 d-flex justify-content-center align-items-center"> <span class="font-weight-bold">
                               <input className="btn btn-solid" type="button" value="Return" onClick={()=>this.returnitem()} />
                                    </span> </div>
                            </div>
                        </div>
