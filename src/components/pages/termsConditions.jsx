                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-sm-12">
                                ...
                                <p style={{textAlign: 'center'}}>{termsconditions["Terms"]}</p>
                            </div>
                            </div>
                        
                                { termsconditions["Terms_details"].map((e, index ) =>
...
const mapStateToProps = (state) => ({
    termsconditions: state.data.privatepolicy[state.filters.country],
