							...
							<div class="header-item item-right" style={{ marginBottom: "-17px",marginTop: "7px" }}>
{
	...
	null
	:
	<FiSearch onClick={()=>setShowSearch(!showSearch)} style={{ fontSize: 24, marginRight: 10, color:"#555555" }} />
}
...
{
	(profile == true)?
<div class={ "d-flex header-item ab useravatar-main"} >
			<div className="row" style={{textAlign:'center'}}>
			<Link to={`${process.env.PUBLIC_URL}/dashboard`}>	<div ><p className='useravatar'>My Account</p></div></Link>
			<Link to={`${process.env.PUBLIC_URL}/myOrders`}><div ><p className=" useravatar">My Orders</p></div></Link>
				{localStorage.getItem("customerData") ?
				<div ><p className=" useravatar" onClick={handleClick}>Logout</p></div>
				:''
			}
